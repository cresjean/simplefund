...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    grunt.registerTask('nginx', 'Copy over the NGINX configuration', function(){
        grunt.task.run(['copy:nginx']);
  ...
  grunt.registerTask('serve', 'Compile then start a connect web server', function (target) {
    ...
    grunt.registerTask('flask', 'Run flask server.', function() {
       ...
       spawn('/home/crespo/Projects/NoodleTree/share-market/env/bin/python', ['main.py'], PIPE);
    });
